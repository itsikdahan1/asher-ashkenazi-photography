      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          ...
          <h1 className="text-6xl md:text-[9rem] font-bold tracking-tighter mb-8 leading-[0.85] max-w-5xl mx-auto">
            ...
            <span className="text-turquoise italic font-serif glow-text">{hero.titleAccent}</span>
          </h1>

          {hero.subtitle && (
            <div className="flex items-center justify-center gap-4 mb-12">
              <div className="h-[1px] w-12 bg-white/20" />
              <p className="text-white/80 text-xl md:text-2xl font-light">{hero.subtitle}</p>
              <div className="h-[1px] w-12 bg-white/20" />
            </div>
          )}
